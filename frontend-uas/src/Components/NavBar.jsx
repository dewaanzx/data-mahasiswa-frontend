...
export default function NavBar() {
  ...
  return (
    <nav className="bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded-b dark:bg-zinc-800">
      <div className="container flex flex-wrap justify-between items-center mx-auto">
        ...
        <div
          ...
          id="navbar-cta"
        >
          <ul className="flex w-full flex-col p-4 mt-4 bg-gray-50 rounded-lg border border-gray-100 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white dark:bg-zinc-800 md:dark:bg-zinc-800 dark:border-gray-700">
            <li>
